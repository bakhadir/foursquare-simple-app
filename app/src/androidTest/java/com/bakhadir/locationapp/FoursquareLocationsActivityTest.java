 ...
 */
public class FoursquareLocationsActivityTest extends ActivityInstrumentationTestCase2<FoursquareLocationsActivity> {

    public static final String TAG = FoursquareLocationsActivityTest.class.getSimpleName();

    private FoursquareLocationsActivity mActivity;
    ...
    public FoursquareLocationsActivityTest() {
        super(FoursquareLocationsActivity.class);
    }
    ...
    // TODO: this block fails test if together with testFoursquareVenuesNearbyRequest() and signal.await(60, TimeUnit.SECONDS);
